...
var moduleMap = { "Extension": () => {
	...
	return __federation_import("./__federation_expose_Extension-zHYwgu6v.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
} };
var seen = {};
