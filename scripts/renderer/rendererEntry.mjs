const currentImports = {};
      ...
      let moduleMap = {
"Extension":()=>{
      dynamicLoadingCss(["style-CadVl1rk.css"], false, 'Extension');
      return __federation_import('./__federation_expose_Extension-Ck_uWjaw.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
